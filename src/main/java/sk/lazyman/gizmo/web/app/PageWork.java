...
public class PageWork extends PageAppTemplate {
    ...
    private void initLayout() {
        ...
        TextFormGroup username = new TextFormGroup(ID_REALIZATOR, new PropertyModel<String>(model, Work.F_REALIZATOR),
                createStringResource("Work.realizator"), LABEL_SIZE, TEXT_SIZE, FEEDBACK_SIZE, true);
        form.add(username);

        TextFormGroup date = new TextFormGroup(ID_DATE, new PropertyModel<String>(model, Work.F_DATE),
                createStringResource("Work.date"), LABEL_SIZE, TEXT_SIZE, FEEDBACK_SIZE, true);
        form.add(date);

        TextFormGroup invoice = new TextFormGroup(ID_INVOICE, new PropertyModel<String>(model, Work.F_INVOICE_LENGTH),
                createStringResource("Work.invoiceLength"), LABEL_SIZE, TEXT_SIZE, FEEDBACK_SIZE, true);
        form.add(invoice);

        TextFormGroup length = new TextFormGroup(ID_LENGTH, new PropertyModel<String>(model, Work.F_WORK_LENGTH),
        ...
        TextFormGroup trackId = new TextFormGroup(ID_TRACK_ID, new PropertyModel<String>(model, Work.F_TRACK_ID),
