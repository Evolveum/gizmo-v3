 ...
 * @author lazyman
 */
public class HCheckFormGroup extends HFormGroup<CheckInput, Boolean> {

    public HCheckFormGroup(String id, IModel<Boolean> value, IModel<String> label, String labelSize, String inputSize,
