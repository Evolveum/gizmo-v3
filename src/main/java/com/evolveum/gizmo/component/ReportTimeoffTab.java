...
public class ReportTimeoffTab extends SimplePanel {
    ...
    public ReportTimeoffTab(String id) {
        super(id);
    ...
    private void showDownloadModal(Form form) {
        ...
        DownloadTimeoffReportConfigPanel content = new DownloadTimeoffReportConfigPanel(ModalDialog.CONTENT_ID, getFilterModel());
